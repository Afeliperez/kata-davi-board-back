...
import { IUserItem, UserItemMapper } from '@adapters/out/persistence/dynamodb/mappers/userItemMapper';
...
export class DynamoDbUserRepository implements IUserRepository {
  ...
  async create(user: ICreateUser): Promise<void> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.create');
    }
  }
  ...
  async listAll(): Promise<IUser[]> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.listAll');
    }
  }
  ...
  async getByCcWithPassword(cc: string): Promise<ICreateUser | null> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.getByCcWithPassword');
    }
  }
  ...
  async getByCc(cc: string): Promise<IUser | null> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.getByCc');
    }
  }
  ...
  async update(cc: string, data: Partial<ICreateUser>): Promise<IUser | null> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.update');
    }
  }
  ...
  async delete(cc: string): Promise<void> {
    try {
      ...
      throw rethrowWithContext(error, 'DynamoDbUserRepository.delete');
    }
  }
}